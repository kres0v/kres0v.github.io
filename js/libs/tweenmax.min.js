    ...
    function (t, e, i) {
      ...
      (r.version = '1.15.0'),
        ...
        (l.render = function (t, e, i) {
            ...
            (t >= f
              ...
              ? ((this._totalTime = this._time = this._cycle = 0),
                ...
                0 > t &&
                  ...
                  0 === v &&
                    (this._initted || !this.vars.lazy || i) &&
                    (y >= 0 && (i = !0), (this._rawPrevTime = c = !e || t || y === t ? t : n))),
                this._initted || (i = !0))
                ...
                this._easeType
                  ? ((l = this._time / v),
                    ...
                    1 === p
                      ...
                      : 4 === p && (l *= l * l * l * l),
                    (this.ratio =
                      1 === u ? 1 - l : 2 === u ? l : 0.5 > this._time / v ? l / 2 : 1 - l / 2))
          ...
          this._onUpdate &&
            ...
            r &&
              ...
              !e &&
                this.vars[r] &&
                this.vars[r].apply(this.vars[r + 'Scope'] || this, this.vars[r + 'Params'] || _),
        ...
        (r.from = function (t, e, i) {
          return (
            (i.runBackwards = !0), (i.immediateRender = 0 != i.immediateRender), new r(t, e, i)
          );
        }),
        ...
        (r.staggerTo = r.allTo =
          function (t, e, n, a, l, u, p) {
            ...
            for (
              h(t) || ('string' == typeof t && (t = i.selector(t) || t), o(t) && (t = s(t))),
                t = t || [],
      ...
      var c = function (t, i, s, r) {
        ...
        for (var n, a, o = p(r), h = i && s && r, l = o.length; --l > -1; )
          (a = o[l]),
            (h || a instanceof e || ((n = a.target === a.vars.onComplete) && s) || (i && !n)) &&
              a.paused(t);
      };
      return (
      ...
      function (t, e, i) {
        ...
        return (
          ...
          (m.add = function (r, n, a, h) {
            var l, _, u, p, c, f;
            if (
              ('number' != typeof n && (n = this._parseTimeOrLabel(n, 0, !0, r)), !(r instanceof t))
            ) {
            ...
            for (var n = [], a = this._first, o = 0; a; )
              r > a._startTime ||
                (a instanceof i
                  ? e !== !1 && (n[o++] = a)
                  : (s !== !1 && (n[o++] = a),
                    t !== !1 && ((n = n.concat(a.getChildren(!0, e, s))), (o = n.length)))),
                (a = a._next);
            return n;
          }),
          ...
          (m.totalDuration = function (t) {
            ...
            return (
              0 !== this.totalDuration() && 0 !== t && this.timeScale(this._totalDuration / t), this
            );
          }),
        ...
        return (
              ...
              (o.onStart = function () {
                a.target.paused(!0),
                  a.vars.time !== a.target.time() &&
                    s === a.duration() &&
                    a.duration(Math.abs(a.vars.time - a.target.time()) / a.target._timeScale),
          ...
          (_.tweenFromTo = function (t, e, i) {
            (i = i || {}),
              ...
              (i.startAt = { onComplete: this.seek, onCompleteParams: [t], onCompleteScope: this }),
          ...
          (_.render = function (t, e, i) {
            ...
            if (
              (t >= c
                ...
                ? (this._locked || (this._totalTime = this._cycle = 0),
                  (this._time = 0),
                  (0 !== m ||
                    (0 === f && y !== r && (y > 0 || (0 > t && y >= 0)) && !this._locked)) &&
            ...
            if (
              (this._initted || (this._initted = !0),
              this._active ||
                (!this._paused && this._totalTime !== d && t > 0 && (this._active = !0)),
              0 === d &&
                this.vars.onStart &&
                0 !== this._totalTime &&
                (e ||
      ...
      var t = 180 / Math.PI,
        ...
        u = function (t, n, a, h, u, p) {
          ...
          for (e.length = i.length = s.length = 0, c = x.length; --c > -1; )
            (f = x[c]), (r[f] = -1 !== u.indexOf(',' + f + ',')), (w[f] = _(t, f, r[f], p));
          ...
          for (l = v.length; --l > -1; ) {
            ...
            for (u = c - d + 1, c = 0, _ = 0; u > _; _ += d)
              (s = h[_]),
                ...
                (o = 2 === d ? 0 : h[_ + 3]),
                (h[c++] = f =
                  3 === d ? new a(s, r, n, o) : new a(s, (2 * r + s) / 3, (2 * r + n) / 3, n));
            h.length = c;
          }
          return m;
        },
        c = function (t, e, i) {
          for (var s, r, n, a, o, h, l, _, u, p, c, f = 1 / i, m = t.length; --m > -1; )
            for (
              p = t[m], n = p.a, a = p.d - n, o = p.c - n, h = p.b - n, s = r = 0, _ = 1;
              i >= _;
              _++
            )
              (l = f * _),
      ...
      function (t, e) {
        ...
        var _,
          ...
          W = function (t, e) {
            ...
            return s >= 0
              ? ((G = 3 === s ? 'ms' : i[s]), (V = '-' + G.toLowerCase() + '-'), G + t)
              : null;
          },
          ...
          $ = (U.convertToPixels = function (t, i, s, r, n) {
            ...
            if ((c && (s = -s), '%' === r && -1 !== i.indexOf('border')))
              ...
              if (
                ((p.cssText =
                  'border:0 solid red;position:' + Q(t, 'position') + ';line-height:0;'),
                '%' !== r && u.appendChild)
              )
                p[_ ? 'borderLeftWidth' : 'borderTopWidth'] = s + r;
              else {
                if (
                  ((u = t.parentNode || F.body),
                  (h = u._gsCache),
                  (l = e.ticker.frame),
                  h && _ && h.time === l)
                )
              ...
              u.appendChild(L),
                ...
                _ &&
                  '%' === r &&
                  a.cacheWidths !== !1 &&
                  ((h = u._gsCache = u._gsCache || {}), (h.time = l), (h.width = 100 * (o / s))),
                0 !== o || n || (o = $(t, i, s, r, !0));
            }
            return c ? -o : o;
          }),
            ...
            return (
              null == t
                ...
                : ((r = 360),
                  (n = t.split('_')),
                  (a =
                    Number(n[0].replace(y, '')) * (-1 === t.indexOf('rad') ? 1 : I) -
                    ('=' === t.charAt(1) ? 0 : e)),
                  n.length &&
                    (s && (s[i] = e + a),
                    -1 !== t.indexOf('short') &&
                      ((a %= r), a !== a % (r / 2) && (a = 0 > a ? a + r : a - r)),
                    -1 !== t.indexOf('_cw') && 0 > a
            ...
            return _
              ? (r = e
                  ? function (t) {
                      ...
                      return (
                        o + p.join(l) + l + e + h + (-1 !== t.indexOf('inset') ? ' inset' : '')
                      );
                    }
                  : function (t) {
                      var e, n, p;
                ...
                ? (a.l++,
                  ...
                  o > 0
                    ? ((a.data['xn' + o] = e + i),
                      ...
                      (a['xn' + o] = e),
                      a.plugin ||
                        ((a.xfirst = new fe(a, 'xn' + o, e, i, a.xfirst || a, 0, a.n, r, a.pr)),
                        (a.xfirst.xs0 = 0)),
                      a)
        ...
        (l = ge.prototype),
          (l.parseComplex = function (t, e, i, s, r, n) {
            ...
            if (
              (this.multi &&
                (M.test(i) || M.test(e)
                  ? ((o = e.replace(M, '|').split('|')), (h = i.replace(M, '|').split('|')))
                  : p && ((o = [e]), (h = [i]))),
              h)
            ) {
        ...
        var Te,
          ...
          De = function (t, e, i) {
            ...
            (e = se(e).split(' ')),
              (i.xOrigin =
                (-1 !== e[0].indexOf('%') ? (parseFloat(e[0]) / 100) * s.width : parseFloat(e[0])) +
                s.x),
              (i.yOrigin =
                (-1 !== e[1].indexOf('%')
          ...
          Me = (U.getTransform = function (t, e, i, s) {
            ...
            if (
              ...
              for (h = (o || '').match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], l = h.length; --l > -1; )
                (_ = Number(h[l])),
                  (h[l] = (u = _ - (_ |= 0)) ? (0 | (u * y + (0 > u ? -0.5 : 0.5))) / y + _ : _);
              if (16 === h.length) {
                var x = h[8],
                  b = h[9],
                  P = h[10],
                ...
                (d.rotation = q * I),
                  ...
                  q &&
                    ...
                    (U = C),
                    (Y = D)),
                  (d.scaleX = (0 | (Math.sqrt(E * E + F * F) * y + 0.5)) / y),
                  (d.scaleY = (0 | (Math.sqrt(U * U + b * b) * y + 0.5)) / y),
                  (d.scaleZ = (0 | (Math.sqrt(Y * Y + P * P) * y + 0.5)) / y),
                  (d.skewX = 0),
                ...
                (d.x = h[4] || 0),
                  ...
                  Math.abs(m) > 90 &&
                    270 > Math.abs(m) &&
                    (g
                      ? ((p *= -1), (m += 0 >= f ? 180 : -180), (f += 0 >= f ? 180 : -180))
                      : ((c *= -1), (m += 0 >= m ? 180 : -180))),
                  (d.scaleX = p),
                  (d.scaleY = c),
                  (d.rotation = f),
                  (d.skewX = m),
                  Se &&
                    ((d.rotationX = d.rotationY = d.z = 0), (d.perspective = w), (d.scaleZ = 1));
              }
              d.zOrigin = T;
                ...
                for (
                  c = s.ieOffsetX || 0,
                    ...
                    s.ieOffsetX = Math.round(
                      (d - ((0 > o ? -o : o) * d + (0 > h ? -h : h) * g)) / 2 + x,
                    ),
                    s.ieOffsetY = Math.round(
                      (g - ((0 > _ ? -_ : _) * g + (0 > l ? -l : l) * d)) / 2 + b,
                    ),
                    de = 0;
                  4 > de;
                  de++
          ...
          Ie = (U.set3DTransformRatio = function (t) {
            ...
            if (C || R.skewX)
              (y = Math.cos(C)),
                ...
                R.skewX &&
                  ...
                  (T = Math.sin(C)),
                  'simple' === R.skewType &&
                    ((w = Math.tan(R.skewX * z)), (w = Math.sqrt(1 + w * w)), (y *= w), (T *= w))),
                (i = -T),
                (a = y);
            else {
                ...
                return (
                  (A[xe] =
                    (R.xPercent || R.yPercent
                      ? 'translate(' + R.xPercent + '%,' + R.yPercent + '%) translate3d('
                      : 'translate3d(') +
                    I +
                    'px,' +
                    E +
            ...
            (u = 1),
              ...
              1 !== D && ((i *= D), (a *= D), (_ *= D), (m *= D)),
              1 !== O && ((e *= O), (n *= O), (l *= O), (f *= O)),
              g && ((p -= g), (r = s * p), (h = o * p), (p = u * p + g)),
              R.svg &&
                ((r += R.xOrigin - (R.xOrigin * e + R.yOrigin * i)),
                (h += R.yOrigin - (R.xOrigin * n + R.yOrigin * a))),
              (r = (w = (r += I) - (r |= 0)) ? (0 | (w * v + (0 > w ? -0.5 : 0.5))) / v + r : r),
              (h = (w = (h += E) - (h |= 0)) ? (0 | (w * v + (0 > w ? -0.5 : 0.5))) / v + h : h),
              (p = (w = (p += F) - (p |= 0)) ? (0 | (w * v + (0 > w ? -0.5 : 0.5))) / v + p : p),
              (S =
                R.xPercent || R.yPercent
                  ? 'translate(' + R.xPercent + '%,' + R.yPercent + '%) matrix3d('
                  : 'matrix3d('),
        ...
        (l = ke.prototype),
          ...
          ve(
            'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent',
            {
              parser: function (t, e, i, s, n, o, h) {
                ...
                for (
                  Se && null != T.force3D && ((d.force3D = T.force3D), (f = !0)),
                ...
                return (
                  ...
                  (p || (Se && c && d.zOrigin)) &&
                    (xe
                      ...
                      : se(p + '', d)),
                  f &&
                    (s._transformType = (d.svg && Te) || (!c && 3 !== this._transformType) ? 2 : 3),
                  n
                );
              },
              prefix: !0,
                ...
                this.p.indexOf('border') && (b[h] = W(b[h])),
                  ...
                  g !== v &&
                    ...
                    '%' === g
                      ? ((u = 100 * (T / m) + '%'), (_ = 100 * (w / d) + '%'))
                      : 'em' === g
                      ? ((x = $(t, 'borderLeft', 1, 'em')), (u = T / x + 'em'), (_ = w / x + 'em'))
                      : ((u = T + 'px'), (_ = w + 'px')),
            ...
            parser: function (t, e, i, s, n, a) {
              var o,
                ...
                d = this.format(
                  (f
                    ? m
                      ? f.getPropertyValue(c + '-x') + ' ' + f.getPropertyValue(c + '-y')
              ...
              if (
                ...
                ((p = Q(t, 'backgroundImage').replace(R, '')), p && 'none' !== p)
              ) {
                for (
                  o = d.split(' '), h = g.split(' '), X.setAttribute('src', p), l = 2;
                  --l > -1;
                  ...
                  (d = o[l]),
                    (_ = -1 !== d.indexOf('%')),
                    _ !== (-1 !== h[l].indexOf('%')) &&
                      ((u = 0 === l ? t.offsetWidth - X.width : t.offsetHeight - X.height),
                      (o[l] = _
          ...
          ve('margin', { parser: pe('marginTop,marginRight,marginBottom,marginLeft') }),
          ve('padding', { parser: pe('paddingTop,paddingRight,paddingBottom,paddingLeft') }),
          ve('clip', {
          ...
          if (
            ...
            if ('all' === this.e) (n.cssText = ''), (r = !0);
              ...
              for (e = this.e.split(' ').join('').split(','), s = e.length; --s > -1; )
                (i = e[s]),
                  h[i] &&
                    (h[i].parse === a ? (r = !0) : (i = 'transformOrigin' === i ? Pe : h[i].p)),
                  Ne(n, i);
        ...
        (l = a.prototype),
                    ...
                    ? p &&
                      ...
                      f &&
                        this._addLazySet(
                          ...
                          this._vars.WebkitBackfaceVisibility || (T ? 'visible' : 'hidden'),
                        ))
                    : (w.zoom = 1),
                  c = l;
                c && c._next;
                      ...
                      ? ((l = parseFloat(p)),
                        ...
                        g
                          ? ((u = parseInt(c.charAt(0) + '1', 10)),
                            ...
                            (u *= parseFloat(c)),
                            (m = c.replace(T, '')))
                          : ((u = parseFloat(c)), (m = d ? c.substr((u + '').length) || '' : '')),
                        '' === m && (m = a in s ? s[a] : f),
                        ...
                        (!l && 0 !== l) || (!u && 0 !== u)
                          ? void 0 !== v[a] && (c || ('NaN' != c + '' && null != c))
                            ? ((i = new fe(v, a, u || l || 0, 0, i, -1, a, !1, 0, p, c)),
                              (i.xs0 =
                                'none' !== c || ('display' !== a && -1 === a.indexOf('Style'))
                                  ? c
                                  : p))
          ...
          (l._enableTransforms = function (t) {
            (this._transform = this._transform || Me(this._target, r, !0)),
              (this._transformType =
                (this._transform.svg && Te) || (!t && 3 !== this._transformType) ? 2 : 3);
          });
        var Ue = function () {
      ...
      (e._onInitAllProps = function () {
        for (
          var t,
            ...
            s = this._tween,
            r =
              s.vars.roundProps instanceof Array ? s.vars.roundProps : s.vars.roundProps.split(','),
            n = r.length,
            a = {},
        ...
        return (
          ...
          u(
            ...
            s(
              ...
              function (t) {
                return (
                  this._p1 * Math.pow(2, -10 * t) * Math.sin(((t - this._p3) * a) / this._p2) + 1
                );
              },
              0.3,
            ),
    ...
    if (!i.TweenLite) {
                ...
                u = ('com.greensock.' + s).split('.'),
                  ...
                  a &&
                    ...
                    'function' == typeof define && define.amd
                      ? define(
                          (t.GreenSockAMDPath ? t.GreenSockAMDPath + '/' : '') + s.split('.').pop(),
                          [],
                          function () {
                            return c;
                          },
      ...
      var v = [0, 0, 1, 1],
        ...
        x = (T.register = function (t, e, i, s) {
          for (
            ...
            for (
              n = h[_], r = s ? g('easing.' + n, null, !0) : l.easing[n] || {}, a = u.length;
              --a > -1;
        ...
        (n.dispatchEvent = function (t) {
          ...
          if (r)
            for (e = r.length, i = this._eventTarget; --e > -1; )
              (s = r[e]),
                s && (s.up ? s.c.call(s.s || i, { type: t, target: i }) : s.c.call(s.s || i));
        });
      ...
      g('Ticker', function (t, e) {
        ...
        b.call(l),
          ...
          (l.sleep = function () {
            null != r &&
              (c && S ? S(r) : clearTimeout(r), (s = p), (r = null), l === a && (o = !1));
          }),
          (l.wake = function () {
          ...
          (l.fps = function (t) {
            return arguments.length
              ? ((i = t), (n = 1 / (i || 60)), (h = this.time + n), l.wake(), void 0)
              : i;
          }),
          (l.useRAF = function (t) {
        ...
        (n.eventCallback = function (t, e, i, s) {
          if ('on' === (t || '').substr(0, 2)) {
            ...
            null == e
              ...
              : ((r[t] = e),
                (r[t + 'Params'] =
                  c(i) && -1 !== i.join('').indexOf('{self}') ? this._swapSelfInParams(i) : i),
                (r[t + 'Scope'] = s)),
          ...
          if (t != this._paused && this._timeline) {
            ...
            !t && e.smoothChildTiming && ((this._startTime += s), this._uncache(!1)),
              ...
              !t &&
                ...
                this.duration() &&
                this.render(
                  e.smoothChildTiming ? this._totalTime : (i - this._startTime) / this._timeScale,
                  !0,
                  !0,
                );
          }
      ...
      var D = g(
          ...
          function (e, i, s) {
            ...
            if (
              ((this._overwrite = h =
                null == h ? Y[D.defaultOverwrite] : 'number' == typeof h ? h >> 0 : Y[h]),
              (o || e instanceof Array || (e.push && c(e))) && 'number' != typeof e[0])
            )
              for (
                this._targets = a = u(e), this._propLookup = [], this._siblings = [], r = 0;
                a.length > r;
                r++
              )
                (n = a[r]),
      ...
      var V = function (t, e, i) {
          var s,
            ...
            n = t._gsTweenID;
          if (
            (L[n || (t._gsTweenID = n = 't' + X++)] || (L[n] = { target: t, tweens: [] }),
            ...
            (o = r[n]) === e ||
              ...
              (o._timeline !== e._timeline
                ...
                : u >= o._startTime &&
                  ...
                  (((f || !o._initted) && 2e-10 >= u - o._startTime) || (p[c++] = o)));
          for (n = c; --n > -1; )
            if (
              ((o = p[n]),
      ...
      (n._init = function () {
        ...
        (n.render = function (t, e, i) {
          ...
          if (this._time !== o || i) {
            ...
            for (
              this._lazy !== !1 && (this._lazy = !1),
                this._active ||
                  (!this._paused && this._time !== o && t >= 0 && (this._active = !0)),
                0 === o &&
                  (this._startAt &&
                    (t >= 0 ? this._startAt.render(t, e, i) : r || (r = '_dummyGS')),
                  this.vars.onStart &&
                    (0 !== this._time || 0 === h) &&
                    (e ||
                      this.vars.onStart.apply(
            ...
            this._onUpdate &&
              ...
              r &&
                ...
                !e &&
                  this.vars[r] &&
                  this.vars[r].apply(this.vars[r + 'Scope'] || this, this.vars[r + 'Params'] || y),
        ...
        (D.from = function (t, e, i) {
          return (
            (i.runBackwards = !0), (i.immediateRender = 0 != i.immediateRender), new D(t, e, i)
          );
        }),
