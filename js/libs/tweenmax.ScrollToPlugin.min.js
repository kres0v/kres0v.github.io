  ...
  var t = document.documentElement,
    ...
    i = function (i, r) {
      var s = 'x' === r ? 'Width' : 'Height',
        ...
        o = document.body;
      return i === e || i === t || i === o
        ? Math.max(t[n], o[n]) - (e['inner' + s] || Math.max(t[a], o[a]))
        : i[n] - i['offset' + s];
    },
    r = _gsScope._gsDefine.plugin({
      ...
      init: function (t, r, s) {
        return (
          ...
          null != r.x
            ? (this._addTween(this, 'x', this.x, 'max' === r.x ? i(t, 'x') : r.x, 'scrollTo_x', !0),
              this._overwriteProps.push('scrollTo_x'))
            : (this.skipX = !0),
          null != r.y
            ? (this._addTween(this, 'y', this.y, 'max' === r.y ? i(t, 'y') : r.y, 'scrollTo_y', !0),
      ...
      set: function (t) {
        ...
        var r = this._wdw || !this.skipX ? this.getX() : this.xPrev,
          ...
          a = r - this.xPrev;
        this._autoKill &&
          (!this.skipX && (a > 7 || -7 > a) && i(this._target, 'x') > r && (this.skipX = !0),
