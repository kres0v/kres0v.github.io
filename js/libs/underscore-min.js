(function () {
  ...
  (j.contains = j.include =
    ...
    (j.sample = function (n, t, r) {
      return null == t || r
        ? (n.length !== +n.length && (n = j.values(n)), n[j.random(n.length - 1)])
    ...
    (j.throttle = function (n, t, r) {
      ...
      return function () {
        ...
        return (
          ...
          (u = arguments),
          0 >= f
            ? (clearTimeout(a), (a = null), (o = l), (i = n.apply(e, u)), (e = u = null))
  ...
  var S = function (n, t, r, e) {
    ...
    if (
      a !== o &&
      !(j.isFunction(a) && a instanceof a && j.isFunction(o) && o instanceof o) &&
      'constructor' in n &&
      'constructor' in t
    )
      return !1;
