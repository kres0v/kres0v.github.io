!(function (e, t) {
    ...
    var n,
      ...
      E = function () {
        ...
        (w = !e.contains(document, g.container.get(0))),
          ...
          g.refreshInterval > 0 && (r = window.setInterval(R, g.refreshInterval)),
          (n = l(T));
      },
      F = function () {
      ...
      b = function (e) {
        'resize' == e.type && (m = g.vertical ? g.container.height() : g.container.width()),
          (d = !0);
      },
      R = function () {
        w ||
      ...
      (this.updateScene = function (t, n) {
        return (
          e.isArray(t)
            ...
            : n
            ? t.update(!0)
            : (e.isArray(d) || (d = []), -1 == e.inArray(t, d) && d.push(t), (d = z(d))),
          f
        );
      }),
  ...
  var i = function (t) {
      var i,
          ...
          duration: function () {
            if (e.isFunction(w.duration)) {
              ...
              (w.duration = parseFloat(w.duration)),
                (!e.isNumeric(w.duration) || w.duration < 0) && (w.duration = p.duration);
          },
          offset: function () {
          ...
          R(),
            v
              .on('change.internal', function (e) {
                'loglevel' !== e.what &&
                  'tweenChanges' !== e.what &&
                  ('triggerElement' === e.what ? x() : 'reverse' === e.what && v.update());
              })
        ...
        C = function () {
          (E = { start: F + w.offset }),
            s && w.triggerElement && (E.start -= s.info('size') * v.triggerHook()),
        ...
        D = function (e) {
          if (i) {
            ...
            z(t, i.call(v)) &&
              !e &&
              (v.trigger('change', { what: t, newval: w[t] }), v.trigger('shift', { reason: t }));
          }
        },
        x = function (t) {
          var n = 0;
        ...
        O = function (e) {
          if (c && s) {
            var t = s.info();
            if (e || 'DURING' !== m) {
              var n = { position: u.inFlow ? 'relative' : 'absolute', top: 0, left: 0 },
                r = c.css('position') != n.position;
              u.pushFollowers
                ? w.duration > 0 &&
                  ('AFTER' === m && 0 === parseFloat(u.spacer.css('padding-top'))
                    ? (r = !0)
                    : 'BEFORE' === m &&
                      0 === parseFloat(u.spacer.css('padding-bottom')) &&
                      (r = !0))
                : (n[t.vertical ? 'top' : 'left'] = w.duration * S),
                c.css(n),
              ...
              var i = o(u.spacer, !0),
                a =
                  w.reverse || 0 === w.duration
                    ? t.scrollPos - E.start
                    : Math.round(S * w.duration * 10) / 10;
              (i.top -= parseFloat(u.spacer.css('margin-top'))),
                (i[t.vertical ? 'top' : 'left'] += a),
                c.css({ top: i.top, left: i.left });
            }
          }
        },
        A = function () {
          if (c && s && u.inFlow) {
            var t = 'AFTER' === m,
              ...
              f = a(u.spacer.css('display')),
              g = {};
            f
              ? ((g['margin-top'] = n || (r && i) ? c.css('margin-top') : 'auto'),
                (g['margin-bottom'] = t || (r && i) ? c.css('margin-bottom') : 'auto'))
              : (g['margin-top'] = g['margin-bottom'] = 'auto'),
              u.relSize.width || u.relSize.autoFullWidth
                ? i
                  ? e(window).width() == u.spacer.parent().width()
                    ? c.css('width', u.relSize.autoFullWidth ? '100%' : 'inherit')
              ...
              u.pushFollowers &&
                ((g['padding' + (o ? 'Top' : 'Left')] = w.duration * S),
                (g['padding' + (o ? 'Bottom' : 'Right')] = w.duration * (1 - S))),
              u.spacer.css(g);
          }
        },
        I = function () {
        ...
        N = function () {
          s &&
            ...
            (((u.relSize.width || u.relSize.autoFullWidth) &&
              e(window).width() != u.spacer.parent().width()) ||
              (u.relSize.height && e(window).height() != u.spacer.parent().height())) &&
            A();
        },
        k = function (e) {
          s &&
            ...
            s.scrollTo(
              s.info('scrollPos') -
                (e.originalEvent.wheelDelta / 3 || 30 * -e.originalEvent.detail),
            ));
        };
      return (
        ...
        (this.duration = function (t) {
          ...
          return arguments.length
            ? (e.isFunction(t) || (i = void 0),
              z(n, t) &&
                (v.trigger('change', { what: n, newval: w[n] }), v.trigger('shift', { reason: n })),
              v)
            : w[n];
        }),
          ...
          if (s)
            if (e)
              if (s.enabled() && y) {
                var t,
                  n = s.info('scrollPos');
                (t = w.duration > 0 ? (n - E.start) / (E.end - E.start) : n >= E.start ? 1 : 0),
                  v.trigger('update', { startPos: E.start, endPos: E.end, scrollPos: n }),
                  v.progress(t);
              } else c && 'DURING' === m && O(!0);
            else s.updateScene(v, !1);
          return v;
        }),
        ...
        (this.progress = function (e) {
          if (arguments.length) {
            ...
            if (
              (0 === w.duration
                ? ((t = S != e), (S = 1 > e && i ? 0 : 1), (m = 0 === S ? 'BEFORE' : 'DURING'))
                : 0 >= e && 'BEFORE' !== m && i
                ? ((S = 0), (m = 'BEFORE'), (t = !0))
                : e > 0 && 1 > e && i
                ? ((S = e), (m = 'DURING'), (t = !0))
              ...
              var o = { progress: S, state: m, scrollDirection: r },
                a = m != n,
                l = function (e) {
                  v.trigger(e, o);
                };
              a && 'DURING' !== n && (l('enter'), l('BEFORE' === n ? 'start' : 'end')),
                l('progress'),
                a && 'DURING' !== m && (l('BEFORE' === m ? 'start' : 'end'), l('leave'));
            }
            return v;
          }
          return S;
        ...
        (this.setPin = function (t, n) {
          ...
          if (((n = e.extend({}, r, n)), (t = e(t).first()), 0 === t.length)) return v;
          ...
          var i = 'absolute' != c.css('position'),
            ...
            s = c.css(['width', 'height']);
          c.parent().show(),
            '0px' === s.width && i && a(o.display),
          ...
          return (
            ...
            u.relSize.width && l.css('width', s.width),
            u.relSize.height && l.css('height', s.height),
            c
              .before(l)
              .appendTo(l)
              .css({
            ...
            (u.relSize.width || u.relSize.autoFullWidth) && c.css('box-sizing', 'border-box'),
        ...
        (this.removePin = function (t) {
          return (
            c &&
              (t || !s
                ? (c.insertBefore(u.spacer).css(u.origStyle), u.spacer.remove())
                : 'DURING' === m && O(!0),
        ...
        (this.addTo = function (e) {
          return (
            e instanceof r &&
              ...
              C(),
              A(),
              s.info('container').on('resize.' + d, function () {
    ...
    o = function (e, t) {
      ...
      if (((e = e[0]), e && e.getBoundingClientRect)) {
        ...
        (n.top = r.top),
          (n.left = r.left),
          t ||
            ((n.top += (window.pageYOffset || document.scrollTop || 0) - (document.clientTop || 0)),
            (n.left +=
              (window.pageXOffset || document.scrollLeft || 0) - (document.clientLeft || 0)));
      }
      return n;
    },
    s = function (e) {
  ...
  return (
    (function (e) {
      ...
      for (t = 0; !l && t < r.length; ++t)
        (l = e[r[t] + 'RequestAnimationFrame']),
          (c = e[r[t] + 'CancelAnimationFrame'] || e[r[t] + 'CancelRequestAnimationFrame']);
      l ||
        (l = function (t) {
